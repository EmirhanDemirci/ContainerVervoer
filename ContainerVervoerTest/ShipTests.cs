        ...
        public void FillPlaces()
        {
            for (int i = 0; i < 6; i++)
            {
                for (int ii = 0; ii < 4; ii++)
                    _places[i].AddContainer(new ContainerVervoer.Models.Container(false, true, 30000));
            }

            _places[0].AddContainer(new ContainerVervoer.Models.Container(true, false, 30000));
            _places[1].AddContainer(new ContainerVervoer.Models.Container(false, true, 30000));
        }
